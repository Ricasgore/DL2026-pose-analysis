...
while True:
    ...
    for (xA, yA, xB, yB) in boxes:
        ...
        '''
        pred_points_x, pred_points_y = predict(model=CNNI, SavingName="Method_Automatic_pose_recognition/checkpoints/CNN-pose-Resnet50_dataset2.ckpt", image=person_image)
