...
class LSPPE(torch.utils.data.Dataset):
    def __init__(self, dataDir='/home/amine_tsp/DL2026/Datasets/lsp', transform=None, crossNum=None,crossIDs=None, theType='train'):
        
        if 'lsp_data.npy' in os.listdir('/home/amine_tsp/DL2026/Datasets/lsp/Preprocessed') and 'lsp_labels.npy' in os.listdir('/home/amine_tsp/DL2026/Datasets/lsp/Preprocessed') :

            self.labels = np.load('/home/amine_tsp/DL2026/Datasets/lsp/Preprocessed'+'/lsp_labels.npy', allow_pickle=True)  
            self.data = np.load('/home/amine_tsp/DL2026/Datasets/lsp/Preprocessed'+'/lsp_data.npy', allow_pickle=True)
            ...
            for i in listImage_len:
                ...
                #print(len(self.data))
            np.save('/home/amine_tsp/DL2026/Datasets/lsp/Preprocessed'+'/lsp_data.npy', self.data)
            np.save('/home/amine_tsp/DL2026/Datasets/lsp/Preprocessed'+'/lsp_labels.npy', self.labels)
...
if __name__ == '__main__':
    ...
    lsppe = LSPPE(transform=tr, theType='train')
