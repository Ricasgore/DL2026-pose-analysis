    ...
    for epoch in range(num_epochs):
        for i, (images, labels) in enumerate(train_loader):
            ...
            if (i + 1) % 2 == 0:
                ...
                np.save('./loss_save_during_training/lossCNN_Basic_dataset1.npy',losses)
...
def plott():
    a = np.load('./loss_save_during_training/lossCNN_Basic_dataset2.npy', allow_pickle=True)
    plt.plot(a)
    plt.savefig('./loss_graph_plot/lossCNN_Basic_dataset2.png')
    plt.close()
    print('finish')
